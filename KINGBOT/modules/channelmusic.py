...
from KINGBOT.modules.play import generate_cover
from KINGBOT.modules.play import arq
from KINGBOT.modules.play import cb_admin_check
from KINGBOT.modules.play import transcode
from KINGBOT.modules.play import convert_seconds
from KINGBOT.modules.play import time_to_seconds
from KINGBOT.modules.play import changeImageSize
from KINGBOT.config import BOT_NAME as bn
from KINGBOT.config import DURATION_LIMIT
from KINGBOT.config import UPDATES_CHANNEL as updateschannel
from KINGBOT.config import que
from KINGBOT.function.admins import admins as a
from KINGBOT.helpers.admins import get_administrators
from KINGBOT.helpers.channelmusic import get_chat_id
from KINGBOT.helpers.decorators import authorized_users_only
from KINGBOT.helpers.filters import command, other_filters
from KINGBOT.helpers.gets import get_file_name
from KINGBOT.services.callsmusic import callsmusic, queues
...
from KINGBOT.services.downloaders import youtube
...
async def play(_, message: Message):
    ...
    if audio:
        if round(audio.duration / 200) > DURATION_LIMIT:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/cecde83c5be55ffb4972a.jpg"
        thumbnail = thumb_name
        duration = round(audio.duration / 200)
        views = "Locally added"
        ...
        try:
            ...
            await lel.edit(
                "**🤷 Song not found.Try another song or maybe your spelling is wrong 😬.**"
            )
            print(str(e))
            return
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        user.first_name = "KINGBOT_AI_ASSISTANT_BOT"
    usar = user
    wew = usar.id
    try:
        # chatdetails = await USER.get_chat(chid)
